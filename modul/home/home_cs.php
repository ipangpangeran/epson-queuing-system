            ...
            <div class="widget-body">                 
               <nav>
                  <ul class="nav nav-center " style="margin-top: 20px">
                     <li><a class="btn btn-well btn-glyph" href="#" style="width:82px" data-toggle="modal" data-target="#confirm"><i class="fontello-icon-cog f30"></i><span class="block">COUNTER CONTROL</span></a></li>
     ...
     <div class="modal-dialog">
        <div class="modal-content">
           ...
           <div class="modal-footer">
              <a href="?link=menu-antrian" class="btn btn-danger danger">Yes</a>
              <a href="?link=home-cs" class="btn btn-danger danger">No</a>
           </div>
        </div>
     </div>
  </div>
