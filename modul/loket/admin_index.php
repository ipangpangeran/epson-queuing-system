                                ...
                                <table id="table" class="table table-striped table-content table-condensed boo-table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="no_mobile" scope="col">NO.Loket <span class="column-sorter"></span></th>
                                            <th class="no_mobile" scope="col">Status Aktif <span class="column-sorter"></span></th>
    ...
    $(document)
     ...
     // DATATABLE
        		...
        		$('#table')
                        ...
                        .dataTable({
                        sScrollY: "374px",
                        sAjaxSource: "modul/loket/json.php",
                        bDeferRender: true,
                        bStateSave: true,
                        OScroller: {
                       ...
                       aaSorting: [
                        ...
                        "fnRender": function (oObj)                              
                        {
                            ...
                            return "<a  class='btn btn-yellow' href='?link=loket&act=Edit&id="+oObj.aData[0]+"'>Edit</a>";
