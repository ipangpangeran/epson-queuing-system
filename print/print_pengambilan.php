...
session_start();
        ...
        <?php
            ...
            $_SESSION['antrian']   = " <h1>No. C$antrian <br>Antrian Pengambilan Barang</h1> ";                        
		?>
...
printer_draw_text($printer, "Pick Up Counter", 350, 19);

//garis 2
printer_draw_line($printer, $var_magin_left, 60, 700, 60);

//buat tulisan
$font = printer_create_font("Halvetica", 140, 60, PRINTER_FW_BOLD, false, false, false, 0);
printer_select_font($printer, $font);
printer_draw_text($printer, "C $antrian", 108, 70);
...
//gambar bmp barcode
printer_draw_bmp(($printer), "C:\\xampp\htdocs\antrian-epson\print\PICKUP COUNTER.bmp", 55, 275);
