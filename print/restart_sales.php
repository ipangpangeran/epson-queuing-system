...
include "config/database.php";
			 ...
			 $location_counter1 = "data_service.txt";
			 $location_counter2 = "data_pengambilan.txt";
...
mysql_query("DELETE FROM total_antrian");
mysql_query("UPDATE temp_antrian SET nomor_antrian = '-' AND loket = '-' ");
