...
session_start();
        ...
        <?php
            ...
            $_SESSION['antrian']   = " <h1>No. A$antrian <br>Antrian Service</h1> ";
...
printer_draw_text($printer, "Service Counter", 354, 19);
...
printer_select_font($printer, $font);
printer_draw_text($printer, "B $antrian", 108, 70);
...
//gambar bmp barcode
printer_draw_bmp(($printer), "C:\\xampp\htdocs\antrian-epson\print\SERVICE COUNTER.bmp", 55, 275);
